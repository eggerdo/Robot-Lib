...
JNIEXPORT jint JNICALL Java_robots_parrot_ctrl_ParrotVideoProcessor_nativeOpenFromFile(JNIEnv* env, jobject thiz, jstring mediafile);
JNIEXPORT jint JNICALL Java_robots_parrot_ctrl_ParrotVideoProcessor_nativeOpenFromURL(JNIEnv* env, jobject thiz, jstring url, jstring format);
...
JNIEXPORT void JNICALL Java_robots_parrot_ctrl_ParrotVideoProcessor_nativeClose(JNIEnv* env, jobject thiz);
...
JNIEXPORT jint JNICALL Java_robots_parrot_ctrl_ParrotVideoProcessor_nativeOpenAudio(JNIEnv* env, jobject thiz, jbyteArray audioframe, jintArray audioframelength);
...
//a call to nativeOpenAudio() - including an unsuccessful one - must be matched by a call to nativeCloseAudio() (or nativeClose())
JNIEXPORT void JNICALL Java_robots_parrot_ctrl_ParrotVideoProcessor_nativeCloseAudio(JNIEnv* env, jobject thiz);
...
JNIEXPORT jint JNICALL Java_robots_parrot_ctrl_ParrotVideoProcessor_nativeOpenVideo(JNIEnv* env, jobject thiz, jobject bitmap);
...
//a call to nativeOpenVideo() - including an unsuccessful one - must be matched by a call to nativeCloseVideo() (or nativeClose())
JNIEXPORT void JNICALL Java_robots_parrot_ctrl_ParrotVideoProcessor_nativeCloseVideo(JNIEnv* env, jobject thiz);
...
JNIEXPORT jint JNICALL Java_robots_parrot_ctrl_ParrotVideoProcessor_nativeDecodeFrame(JNIEnv* env, jobject thiz);
...
JNIEXPORT jint JNICALL Java_robots_parrot_ctrl_ParrotVideoProcessor_nativeUpdateBitmap(JNIEnv* env, jobject thiz);
...
JNIEXPORT void JNICALL Java_robots_parrot_ctrl_ParrotVideoProcessor_nativeClose(JNIEnv* env, jobject thiz)
{
    ...
    Java_robots_parrot_ctrl_ParrotVideoProcessor_nativeCloseVideo(env, thiz);
