...
public class CommandEncoder {
	...
	public static boolean parseLoginResp(Rover2Controller controller, Message response)
	{
		...
		try	{
			...
			{
			String challenge_1 = Utils.intToHex(challenge[0]);
			String challenge_2 = Utils.intToHex(challenge[1]);
			String challenge_3 = Utils.intToHex(challenge[2]);
			String challenge_4 = Utils.intToHex(challenge[3]);
			
			Log.w(TAG, "challenge:" + challenge_1 + "," + challenge_2 + "," + challenge_3 + "," + challenge_4);
			}
			
			BlowFish blowfish = new BlowFish(P, S);
			...
			String verify_1 = Utils.intToHex(challenge_verify[0]);
			String verify_2 = Utils.intToHex(challenge_verify[1]);
			String verify_3 = Utils.intToHex(challenge_verify[2]);
			String verify_4 = Utils.intToHex(challenge_verify[3]);
	...
	{
		Log.d(TAG, "batteryPowerReq");
		return new CommandEncoder().new Command(BATTERY_POWER_REQ, BATTERY_POWER_REQ_LEN).output();
	}
